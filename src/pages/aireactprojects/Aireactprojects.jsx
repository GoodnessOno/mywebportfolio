...
import  jsfatiguepic from '../../assets/AI IN REACT PROJECTS.png'
import './aireactprojects.css'
import { Navbar, Footer } from '../../components'
import { Helmet } from 'react-helmet'

const aireact = ({ description }) => {
  return (
    <div class="aireact container-fluid">
      <Navbar />
      <Helmet>
        <title>Integrating AI into React Projects for Enhanced User Experience</title>
        <meta
          name='description'
          content='Learn how to integrate AI into React projects to enhance user experience. Discover tools and techniques for creating smarter, more responsive web applications.'
        />
      </Helmet>
      <div className='aireact-content'>
      <div className='aireact-title'>
        <h1>Integrating AI into React Projects for Enhanced User Experience</h1>
      </div>
        <div className='aireact-image'>
          <img src={jsfatiguepic} alt="jsfatiguebanner" />
        </div>
        <div className='aireact-text'>
          <h2>Introduction</h2>
          <br />
